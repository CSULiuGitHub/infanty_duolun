...
/* 摩擦轮电机和射速控制 */
/* 根据射速上限分级 */
//float Tar_Speed_Lim15 = 14.5; /*< 射速上限为15 单位(m/s)*/
...
int16_t Shoot_Speed_Max_M3508_Lim18 = 5100;
int16_t Shoot_Speed_Max_M3508_Lim22 = 5780;
int16_t Shoot_Speed_Max_M3508_Lim30 = 7600;
...
#ifdef INFANTRY_3
/* 速度环 */
float Shoot_Freq_Speed_Kp = 10.0;
float Shoot_Freq_Speed_Ki = 0.4;
float Shoot_Freq_Speed_Kd = 4;
float Shoot_Freq_Speed_Kp_Limit = 9999;
float Shoot_Freq_Speed_Ki_Limit = 9999;

/* 位置环 */
float Shoot_Freq_Position_Kp = 1.1;
...
/* 拨弹电机 */
/* 速度环 */
float Shoot_Freq_Speed_Kp = 600;
float Shoot_Freq_Speed_Ki = 0;
float Shoot_Freq_Speed_Kd = 0;
float Shoot_Freq_Speed_Kp_Limit = 9999;
float Shoot_Freq_Speed_Ki_Limit = 9999;

/* 位置环 */
float Shoot_Freq_Position_Kp = 0.02;
float Shoot_Freq_Position_Ki = 0;
float Shoot_Freq_Position_Kd = 0;
float Shoot_Freq_Position_Kp_Limit = 9999;
float Shoot_Freq_Position_Ki_Limit = 9999;
...
/* 拨弹电机 */
/* 速度环 */
float Shoot_Freq_Speed_Kp = 800;//800;
float Shoot_Freq_Speed_Ki = 0;
float Shoot_Freq_Speed_Kd = 0;
float Shoot_Freq_Speed_Kp_Limit = 9999;
float Shoot_Freq_Speed_Ki_Limit = 9999;
...
/* 位置环 */
float Shoot_Freq_Position_Kp = 0.05;//0.02;
float Shoot_Freq_Position_Ki = 0;
float Shoot_Freq_Position_Kd = 0;
float Shoot_Freq_Position_Kp_Limit = 9999;
float Shoot_Freq_Position_Ki_Limit = 9999;
...
/* 两个3508电机（摩擦轮） */
/* 速度环 */
float Shoot_Freq_Speed_Kp_M3508 = 70;
...
float Shoot_Freq_Position_Ki_Limit = 9999;
/* 摩擦轮电机限制占空比，绝对防止超速 */
uint16_t Pusel_Max_Lim15 = 255;
uint16_t Pusel_Max_Lim18 = 270;
uint16_t Pusel_Max_Lim22 = 290;
uint16_t Pusel_Max_Lim30 = 455;
uint16_t Pulse_Min = 235;
uint16_t Pulse_Out = 240; /*< 初始射速 */
